        ...
        <div className='row'>
          <div className='col'>
            <div className="d-grid gap-2">
              <button  className='btn btn-danger mt-2' onClick={userSignOut}>Cerrar Sesion</button>
                ...
                { usuarios.map( (usuario) => (
                  <tr key={usuario.id}>
                    ...
                    <td>
                      ...
                      <button type="button" onClick={ () => { confirmDelete(usuario.id, usuario.email, usuario.password) } } className="btn btn-danger"><i className="fa-solid fa-trash"></i></button>
                    </td>
                  </tr>                
                )) }
              </tbody>
